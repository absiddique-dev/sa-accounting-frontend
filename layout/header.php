...
<head>
    ...
    <title>Home | SA Accounting</title>
    <!--=====CSS LINK=======-->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="header-elements">
                            <div class="site-logo">
                                <a href="/">
                                    <img src="assets/images/logo/logo.png" alt="" class="img-fluid" style="width: 50px; height: auto;" />
                                </a>
                            </div>
                            ...
                            <div class="contact-3 d-lg-block d-none">
                                <div class="all-3-btn theme-btn1">
                                    <div class="theme-btn-2">
                                        <img
                                            src="assets/images/icons/phone2.svg"
                                            alt=""
                                            class="imgicon" />
                                        <a
    ...
    <div class="mobile-sidebar">
        ...
        <div class="mobile-nav">
            ...
            <div class="allmobilesection">
                <a
                    href="#"
                    class="font-outfit font-18 lineh-18 weight-700 color mobilemenubtn">Get Started</a>
                <div class="single-footer single-footer-menu single-footer4">
                    <h3
                        class="font-outfit font-24 lineh-24 weight-600 color margin-b margin-t24">
                        Contact Info
                    </h3>
